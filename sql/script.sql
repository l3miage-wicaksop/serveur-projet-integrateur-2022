...
insert into chamis (userid, age) values ('carobis', 21 );
insert into chamis (userid, age) values ('escribis', 43 );
insert into chamis (userid, age) values ('momo', 38 );
insert into chamis (userid, age) values ('nomoldu', 20 );
insert into chamis (userid, age) values ( 'python38', 18 );
insert into chamis (userid, age) values ('yes4moldus', 38 );

...
insert into chamis (userid, age) values ('D132','carobis', 21 );
insert into chamis (userid, age) values ('D99','escribis', 43 );
insert into chamis (userid, age) values ('D22' ,'momo', 38 );
insert into chamis (userid, age) values ('D102','nomoldu', 20 );
insert into chamis (userid, age) values ('D66', 'python38', 18 );
insert into chamis (userid, age) values ('D32', 'yes4moldus', 38 );
